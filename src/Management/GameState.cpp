...
namespace sg
{
    ...
    {
        GameWindow* gameWindow = NULL;// return NULl if not found
        if (windowIdx < gameWindows.size())
        {
            gameWindow = gameWindows[windowIdx];
        }
    ...
    {
        GameWorld* gameWorld = NULL;// return NULl if not found
        if (worldIdx < gameWorlds.size())
        {
            gameWorld = gameWorlds[worldIdx];
        }
